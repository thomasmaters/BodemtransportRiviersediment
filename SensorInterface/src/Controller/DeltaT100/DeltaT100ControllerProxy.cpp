...
{
DeltaT100ControllerProxy::DeltaT100ControllerProxy(const std::string& host,
...
void Controller::DeltaT100::DeltaT100ControllerProxy::handleResponse(uint8_t*,
                                                                     std::size_t,
                                                                     std::chrono::milliseconds::rep)
{
}

Messages::SensorMessage DeltaT100ControllerProxy::handleRequest(uint8_t*, std::size_t, std::chrono::milliseconds::rep)
{
